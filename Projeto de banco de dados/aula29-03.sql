...
where  Cpf = Cpf_gerente and Dnum = dnumero and projlocal = 'Maua';

select P.Projnumero, D.Dnumero, F.Unome, F.Endereco, F.Datanasc
from Funcionario F, Departamento D, Projeto P 
where F.Cpf = Cpf_gerente and P.Dnum = dnumero and P.projlocal = 'Maua';

select F.Cpf, D.Dnome 
from Funcionario F, Departamento D
where F.Cpf and D.Dnome;
...
select * from funcionario
where(Salario between 30000 and 40000) and Dnr = 5; #joao

select D.Dnome, F.Unome, F.Pnome, P.Projnumero
