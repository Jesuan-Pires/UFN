...
//			}
	...
	public void carregarProdutosDoArquivo() {
		try {			
			...
			/*O método hasNextLine() retorna true se houver uma linha seguinte para ser lida no 
			 * arquivo e retorna false caso contrário. Portanto, o laço while continuará executando
